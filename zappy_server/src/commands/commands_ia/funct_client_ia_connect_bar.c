...
** File description:
** funct_client_ia_connect_bar
*/

#include "zappy.h"

/**
 @brief receive and prepare the elements needed to prepare the order that will be processed by the server for the command bar
...
void funct_client_ia_connect_bar(ia_t *ia, char **args, common_t *com)
{
    ...
    new_msg->start = 0;
    new_msg->msg = NULL;
    new_msg->handler = &funct_response_ia_connect_bar;
